...
//   }
  ...
  //             hcounter++;
  //             // cout << "count increasing to " << counter << endl;
  //             if (hcounter == 4){
  //                 return true;
  //             }
  ...
  //         } else{
  //             hcounter = 0;
  //             // cout << "count resetting to " << counter << endl;
  //         }
  //     }
  //   }
  ...
  dcounter = 0;
  for (int r = ROWS-1;  r >=0 ; r--){
    for (int c = COLS-1, x = r ; c >= 0, x >=0 ; c--,x--)
    {
      if (board[c][x] == currTile)
    {
      dcounter++;
      cout << c << " " << 5 << endl;
      cout << "count increasind to " << dcounter << endl;
      if (dcounter == 4)
      {
        return true;
      }
      ...
      dcounter = 0;
      cout << c << " " << x << endl;
      cout << "count resseting to " << dcounter << endl;
    }
    }
  }
  ...
  for (int r = ROWS-1;  r >=0 ; r--){
    for (int c = COLS-1, x = r ; c >= 0, x >=0 ; c--,x--)
    {
      if (board[x][c] == currTile)
    {
      d2counter++;
      cout << x << " " << c << endl;
      cout << "count increasind to " << d2counter << endl;
      if (d2counter == 4)
      {
        return true;
      }
      ...
      d2counter = 0;
      cout << x << " " << c << endl;
      cout << "count resseting to " << d2counter << endl;
    }
    }
  }
  //   for (int i = b[ROWS][COLS].length - 1; i > 0; i--) {
  //      String temp = "";
